...
tf.app.flags.DEFINE_integer('max_iters', 200000, "Max iteration")
tf.app.flags.DEFINE_integer('step_size', 150000, "Step size for reducing the learning rate, currently only support one step")
